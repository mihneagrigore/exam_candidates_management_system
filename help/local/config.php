...
$WikiTitle = 'Instructiuni platforma admitere';

##  $ScriptUrl is the URL for accessing wiki pages with a browser.
##  $PubDirUrl is the URL for the pub directory.
$ScriptUrl = 'https://admitere.moisil.ro/help/pmwiki.php';
$PubDirUrl = 'https://admitere.moisil.ro/help/pub';
